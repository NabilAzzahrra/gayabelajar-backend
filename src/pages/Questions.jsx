...
function Questions() {
  ...
  const getResult = async (data) => {
    await axios
      .get(
        `https://gayabelajar-backend.politekniklp3i-tasikmalaya.ac.id/hasils/${data.id}`
      )
      .then((response) => {
  ...
  const getQuestions = async () => {
    await axios
      .get(
        "https://gayabelajar-backend.politekniklp3i-tasikmalaya.ac.id/questions"
      )
      .then((response) => {
  ...
  const handleFinish = async (answer) => {
    ...
    await axios.post("https://gayabelajar-backend.politekniklp3i-tasikmalaya.ac.id/tests", {
      answers: bucket,
    })
      .then(() => {
